...
| Framework UI | Jetpack Compose | 1.5+ |
| Sistema de Diseño | Material Design | 3.0 |
| Autenticación | Firebase Authentication | 22.3.0 |
| Base de Datos | Cloud Firestore | 24.10.0 |
...
|-------|------|---------------|-------------|
| id | string | PK, NOT NULL | Identificador único autogenerado |
| nombre | string | NOT NULL, MAX 100 | Denominación del curso |
| descripcion | string | NULLABLE, MAX 500 | Información descriptiva |
| creditos | number | NOT NULL, MIN 1, MAX 8 | Valor crediticio |
| userId | string | FK, NOT NULL, INDEXED | Referencia al usuario propietario |
...
1. Navegación: **Authentication > Sign-in method**
...
1. Navegación: **Firestore Database > Create database**
...
1. Agregar app Android al proyecto Firebase
...
```bash
git clone https://github.com/[username]/GalvanGuerrero-MisCursosApp.git
...
- **Repositorio:** [GitHub](https://github.com/[username]/GalvanGuerrero-MisCursosApp)
...
**© 2025 - Todos los derechos reservados para fines académicos**
